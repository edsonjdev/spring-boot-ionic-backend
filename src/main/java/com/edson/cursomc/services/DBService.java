...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat8 = new Categoria(null, "Cosmeticos");
		
		Produto p1 = new Produto(null, "Computador", 2000.00);
		Produto p2 = new Produto(null, "Impressora", 800.00);
		Produto p3 = new Produto(null, "Mouse", 80.00);
		Produto p4 = new Produto(null, "Mesa de escitorio", 300.00);
		Produto p5 = new Produto(null, "Toalha", 50.00);
		Produto p6 = new Produto(null, "Colcha", 200.00);
		Produto p7 = new Produto(null, "Mouse", 80.00);
		...
		Produto p11 = new Produto(null, "Shampp", 90.00);
		...
		Cliente cli1 = new Cliente(null, "Edson Joaquim", "edsonjay53@gmail.com", "90514177640", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("843333333", "82333332"));
		
		Cliente cli2 = new Cliente(null, "Edson Mapar", "edsonj.dev@gmail.com", "60301122520", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		//salvamos telefones
		cli2.getTelefones().addAll(Arrays.asList("843333333", "82333332"));
		...
		Endereco e3 = new Endereco(null, "Rua Picardo", "300", "Ruas 303", "Barca", "33333333", cli2, c2);
